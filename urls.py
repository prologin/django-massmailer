...
template_patterns = [
    ...
    path('preview', massmailer.views.TemplatePreviewView.as_view(), name='preview'),
    path('<int:id>', massmailer.views.UpdateTemplateView.as_view(), name='update'),
    path('<int:id>-<slug>', massmailer.views.UpdateTemplateView.as_view(), name='update'),
]

query_patterns = [
    path('', massmailer.views.CreateQueryView.as_view(), name='new'),
    path('preview', massmailer.views.QueryPreviewView.as_view(), name='preview'),
    path('<int:id>', massmailer.views.UpdateQueryView.as_view(), name='update'),
    path('<int:id>-<slug>', massmailer.views.UpdateQueryView.as_view(), name='update'),
]

batch_obj_patterns = [
    path('', massmailer.views.BatchDetailView.as_view(), name='detail'),
    path('retry', massmailer.views.BatchRetryView.as_view(), name='retry-pending'),
